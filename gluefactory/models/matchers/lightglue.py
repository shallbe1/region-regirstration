...
class TransformerLayer(nn.Module):
    ...
    def forward(
        ...
        if mask0 is not None and mask1 is not None:
            ...
            #print(desc0.device, encoding0.device)
...
class LightGlue(nn.Module):
    ...
    def __init__(self, conf) -> None:
        ...
        if conf.weights is not None:
            ...
            if Path(conf.weights).exists():
                ...
                print(self.url.format(conf.weights_from_version, conf.weights),fname,"============11111")

        if state_dict:
            # rename old state dict entries
            #print(state_dict,"===")
            #for (a1,a2) in state_dict:
            #    print(a2)
    ...
    def forward(self, data: dict) -> dict:
        ...
        device = kpts0.device
        #print(device,"---------")
        #size0=torch.tensor([680,850]).to(device)
        #size1=torch.tensor([680,850]).to(device)
        ...
        #print(kpts0.device,size1.device)
